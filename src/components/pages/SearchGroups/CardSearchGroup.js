    ...
    function renderSubscriptionButtons() {
        return <div className="btnIcon">
            { 
                ...
                :
                    <div className="unsubscribeBut">
                        <button onClick={() => unSubscribeGroup(storedToken, props.Group.id,props.ForceRenderGroup)} className="btn-danger p-1 rounded-2">Se désabonner</button>
                    </div>
            }
        </div>
    }
