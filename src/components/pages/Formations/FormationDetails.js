        ...
        <div>
            <div>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Details Formation</h1>
                    ...
                    <div className="ms-auto pageheader-btn">
                        <Link to={`${process.env.PUBLIC_URL}/pages/FormationEdit`}
              ...
              <span>
                <i className="fe fe-refresh-ccw"></i>&nbsp;
                        ...
                        <Link to={`${process.env.PUBLIC_URL}/pages/FormationList`}
                                ...
                                <div className="">
                                    <div className="d-flex overflow-visible blogimg">
                                        ...
                                        <div className="ps-1 flex-column">
                                            <h4>
                                                <Link
                                                    to={`${process.env.PUBLIC_URL}/pages/FormationDetail`}
                                                >
