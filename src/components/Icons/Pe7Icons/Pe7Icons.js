...
import { Col, OverlayTrigger, Row, Tooltip, Breadcrumb,Card } from "react-bootstrap";
export default function Pe7Icons() {
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">Pe7 Icons</h1>
              ...
              <Row>
                <Col sm={12} lg={12}>
                  <p>
                    ...
                    <Link
                      to="https://themes-pixeden.com/font-demos/7-stroke/"
                      target="_blank"
                    >
                      click here
                    </Link>
